  ...
  static function resolve_url($url, $proto, $host, $base_path) {
    ...
    try {
      ...
      // Remote allowed or DataURI
        ...
        $full_url = build_url_($proto, $host, $base_path, $url);
      ...
      // Not remote, local image
        ...
        $resolved_url = build_url_($proto, $host, $base_path, $url);
      }
  
  
      // Check if the local file is readable
      if ( !is_readable($resolved_url) || !filesize($resolved_url) ) {
        throw new DOMPDF_Image_Exception("Image not readable or empty: " . $resolved_url);
      }
  ...
  //*/
   ...
   static function resolve_url($url, $proto, $host, $base_path) {
     ...
     if ( !DOMPDF_ENABLE_REMOTE && $remote ) {
       ...
       // Download remote files to a temporary directory
       $url = build_url_($proto, $host, $base_path, $url);
